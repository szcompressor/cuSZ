#ifndef PSZ_KERNEL_LRZ_GPU_CONFIG_INL
#define PSZ_KERNEL_LRZ_GPU_CONFIG_INL
...
struct c_lorenzo<1> {
  ...
  static constexpr dim3 sequentiality = dim3(4, 1, 1);
...
struct c_lorenzo<2> {
  ...
  static constexpr dim3 sequentiality = dim3(1, 8, 1);
  static constexpr dim3 seq = sequentiality;
...
template <>
struct c_lorenzo<2, 64, 32> {
  static constexpr dim3 tile = dim3(64, 32, 1);
  static constexpr dim3 sequentiality = dim3(2, 8, 1);
  static constexpr dim3 seq = sequentiality;
  static constexpr dim3 thread_block = dim3(32, 4, 1);
  static dim3 thread_grid(dim3 len3) { return div3(len3, tile); };
...
template <>
struct c_lorenzo<2, 128, 32> {
  static constexpr dim3 tile = dim3(128, 32, 1);
  static constexpr dim3 sequentiality = dim3(4, 8, 1);
  static constexpr dim3 seq = sequentiality;
  static constexpr dim3 thread_block = dim3(32, 4, 1);
  static dim3 thread_grid(dim3 len3) { return div3(len3, tile); };
...
struct c_lorenzo<3> {
  ...
  static constexpr dim3 sequentiality = dim3(1, 1, 8);
  static constexpr dim3 seq = sequentiality;
