...
psz::FzgCodec::FzgCodec(size_t const data_len) : pimpl{std::make_unique<impl>(data_len)} {}
...
size_t psz::FzgCodec::expose_padded_input_len() const { return pimpl->config.at("pad_len"); }

void psz::FzgCodec::clear_buffer() { pimpl->buf->clear_buffer(); }
