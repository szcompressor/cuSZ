...
struct HFR_PBK_decoder {
  ...
  static int GPU_kernel(
      H* in_pbk_bitstream, size_t pbk_bitstream_len, uint8_t* in_RVBKs_r128_25, int revbook_nbyte,
      uint32_t const* pbk_packed_headers, int pbk_pardeg, size_t data_len, Eout* out_decoded,
      uint8_t* out_incomp_flag, void* stream);
};
