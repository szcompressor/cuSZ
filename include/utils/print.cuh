...
template <>
void typed_printf<uint32_t>(const uint32_t i)
{
    printf("%u\t", i);
}

template <>
void typed_printf<uint16_t>(const uint16_t i)
{
    printf("%u\t", (uint32_t)i);
}

template <>
void typed_printf<uint8_t>(const uint8_t i)
{
    printf("%u\t", (uint32_t)i);
}

template <>
void typed_printf<float>(const float i)
{
    printf("%.7f\t", i);
}
