...
template <_ptb_dtype T> struct Ctype;
...
template <> struct TypeSym<f4> { static const _ptb_dtype type = F4; static const int width = sizeof(f4); };
template <> struct TypeSym<f8> { static const _ptb_dtype type = F8; static const int width = sizeof(f8); };
template <> struct TypeSym<i1> { static const _ptb_dtype type = I1; static const int width = sizeof(i1); };
template <> struct TypeSym<i2> { static const _ptb_dtype type = I2; static const int width = sizeof(i2); };
template <> struct TypeSym<i4> { static const _ptb_dtype type = I4; static const int width = sizeof(i4); };
template <> struct TypeSym<i8> { static const _ptb_dtype type = I8; static const int width = sizeof(i8); };
template <> struct TypeSym<u1> { static const _ptb_dtype type = U1; static const int width = sizeof(u1); };
