...
static const char cusz_short_doc[] =
    ...
    "\n"
    "example:\n"
    "  zip 1: ./bin/cusz -t f32 -m r2r -e 1e-4 -i ./data/ex-cesm-CLDHGH "
    "--config demo=cesm -z --report time\n"
    "  zip 2: ./bin/cusz -t f32 -m r2r -e 1e-4 -i ./data/ex-cesm-CLDHGH -l "
    "3600,1800 -z --report time\n"
    "  unzip: ./bin/cusz -i ./data/ex-cesm-CLDHGH.sz -x --report time,quality "
    "--compare "
    "./data/ex-cesm-CLDHGH\n"
    "\n"
    "\"cusz -h\" for details.\n";
...
static const char cusz_full_doc[] =
    ...
    "        *cusz* *-t* f32 *-m* r2r *-e* 1.0e-4.0 *-i* ./data/ex-cesm-CLDHGH *-l* 3600,1800 *-z* *--report* time\n"
    //       cusz -t f32 -m r2r -e 1.0e-4.0 -i ./data/ex-cesm-CLDHGH -l 3600,1800 -z --report time\n
    "             ------ ------ ----------- ------------------------ ------------  | \n"
    "              dtype  mode  error bound      input datum file    low-to-high  zip \n"
    "\n"
    "        *cusz* *-i* ./data/ex-cesm-CLDHGH.sz *-x* *--compare* ./data/ex-cesm-CLDHGH *--report* time,quality\n"
    //       cusz -i ./data/ex-cesm-CLDHGH.sz -x --compare ./data/ex-cesm-CLDHGH --report time,quality\n"
    "             ---------------------------  | \n"
    "                       sz archive        unzip \n"
    "\n"
    ...
    "        mkdir data2 data3\n"
    "        %# zip, output to `data2`%\n"
    "        ./bin/cusz -t f32 -m r2r -e 1e-4 -i ./data/ex-cesm-CLDHGH --demo cesm -z --opath data2\n"
    "        %# unzip, in situ%\n"
    ...
    "        ./bin/cusz -i ./data2/ex-cesm-CLDHGH.sz -x --opath data3 --compare ./data/ex-cesm-CLDHGH && ls "
    "data3\n"
    "\n"
    "        *Hurricane Isabel* example:\n"
    "        ./bin/cusz -t f32 -m r2r -e 1e-4 -i ./data/ex-hurr-CLOUDf48 --demo hurricane -z\n"
...
// TODO
// "        *EXAFEL* example:\n"
// "        ./bin/cusz -t f32 -m r2r -e 1e-4 -i ./data/ex-exafel-59200x388 --demo exafeldemo -z -x --pre binning\n"
// "        ./bin/cusz -t f32 -m r2r -e 1e-4 -i ./data/ex-exafel-59200x388 --demo exafeldemo -z -x --pre binning "
// "--skip huffman\n"
