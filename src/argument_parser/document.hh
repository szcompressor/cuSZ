...
static const char cusz_short_doc[] =
    ...
    "            Alternative to \",\", \"x\" can also be delimiter.\n"
    ...
    "   cusz -t f32 -m r2r -e 1e-4 -i ${CESM} -l 3600x1800 -z --report time   ## \"-z\", compress\n"
    "   cusz -i ${CESM}.cusza -x --report time --compare ${CESM}              ## \"-x\", decompress\n"
    "\n"
    "\"cusz -h\" for details.\n";
