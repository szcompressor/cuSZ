...
static const char cusz_short_doc[] =
    ...
    "              alternative to \"-e <eb>\"\n"
    "      + demo  skip length input (\"-l x[,y[,z]]\")\n"
...
static const char cusz_full_doc[] =
    ...
    "                       sz archive        unzip \n"
    "\n"
    "        *cusz* *-t* f32|64 *-m* [eb mode] *-e* [eb] *-i* [datum file] *--demo* [demo dataset] *-z*\n"
    ...
    "    *Demo Datasets*\n"
    "        *CESM* example:\n"
    "        ./bin/cusz -t f32 -m r2r -e 1e-4 -i ./data/cesm-CLDHGH-3600x1800 --demo cesm -z --report time\n"
    "        ./bin/cusz -t f32 -m r2r -e 1e-4 -i ./data/cesm-CLDHGH-3600x1800 --demo cesm -r\n"
    "        ./bin/cusz -i ./data/cesm-CLDHGH-3600x1800.cusza -x --report time,quality --compare "
    "./data/cesm-CLDHGH-3600x1800 "
    "--skip "
    "write2disk\n"
    "\n"
    ...
    "        mkdir data2 data3\n"
    "        %# zip, output to `data2`%\n"
    "        ./bin/cusz -t f32 -m r2r -e 1e-4 -i ./data/cesm-CLDHGH-3600x1800 --demo cesm -z --opath data2\n"
    "        %# unzip, in situ%\n"
    "        ./bin/cusz -i ./data2/cesm-CLDHGH-3600x1800.cusza -x && ls data2\n"
    "        %# unzip, output to `data3`%\n"
    "        ./bin/cusz -i ./data2/cesm-CLDHGH-3600x1800.cusza -x --opath data3 && ls data3\n"
    "        %# unzip, output to `data3`, compare to the original datum%\n"
    "        ./bin/cusz -i ./data2/cesm-CLDHGH-3600x1800.cusza -x --opath data3 --compare ./data/cesm-CLDHGH-3600x1800 "
    "&& ls "
    "data3\n"
    "\n"
    "        *Hurricane Isabel* example:\n"
    "        ./bin/cusz -t f32 -m r2r -e 1e-4 -i ./data/hurr-CLOUDf48-500x500x100 --demo hurricane -z\n"
    "        ./bin/cusz -t f32 -m r2r -e 1e-4 -i ./data/hurr-CLOUDf48-500x500x100 --demo hurricane -r\n"
    "        ./bin/cusz -i ./data/hurr-CLOUDf48.cusza -x\n"
    "\n";
