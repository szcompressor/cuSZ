...
// #define HUFFMAN_COARSE HuffmanCodec<T, H, M>

// TEMPLATE_TYPE
// HUFFMAN_COARSE::~HuffmanCodec() { pimpl.reset(); }

// TEMPLATE_TYPE
// HUFFMAN_COARSE::HuffmanCodec() : pimpl{std::make_unique<impl>()} {}

// TEMPLATE_TYPE
// HUFFMAN_COARSE::HuffmanCodec(const HUFFMAN_COARSE& old) : pimpl{std::make_unique<impl>(*old.pimpl)}
// {
...
// TEMPLATE_TYPE
// HUFFMAN_COARSE::HuffmanCodec(HUFFMAN_COARSE&&) = default;
