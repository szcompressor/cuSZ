...
#define INIT2(H)                                                           \
  ...
  template void _2403::hf_encode_coarse_phase4(                            \
...
template void _2403::hf_encode_coarse_phase3(
