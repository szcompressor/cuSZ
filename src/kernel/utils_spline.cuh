...
__device__ void c_spline3d_reset_scratch_33x9x9data(
    ...
    for (auto i = 0; i < NumIters; i++) {
        ...
        if (_tix < 33 * 9 * 9) {
            ...
            /*****************************************************************************
             okay to use
             ******************************************************************************/
            if (x % 8 == 0 and y % 8 == 0 and z % 8 == 0) shm_err_ctrl[z][y][x] = radius;
            /*****************************************************************************
             alternatively
             ******************************************************************************/
            // shm_err_ctrl[z][y][x] = radius;
        }
    }
    __syncthreads();
}
    ...
    int         radius = 512)
{
    ...
    for (auto i = 0; i < NumIters; i++) {
        ...
        if (_tix < 33 * 9 * 9) {
            ...
            shm_err_ctrl[z][y][x] = 0;  // TODO explicitly handle zero-padding
            ...
            if (x % 8 == 0 and y % 8 == 0 and z % 8 == 0) {
                ...
                auto aid = (x / 8) + bix * 4 +                  //
                           (y / 8) * stride3d_anchor.y + biy +  //
                           (z / 8) * stride3d_anchor.z + biz;   // TODO recheck
