...
template <typename T, typename EQ, typename FP, int BLOCK, int SEQ>
__global__ void x_lorenzo_1d1l(EQ* eq, T* outlier, dim3 len3, dim3 stride3, int radius, FP ebx2, T* xdata);
...
template <typename T, typename EQ, typename FP>
__global__ void x_lorenzo_2d1l(EQ* eq, T* outlier, dim3 len3, dim3 stride3, int radius, FP ebx2, T* xdata);
...
template <typename T, typename EQ, typename FP>
__global__ void x_lorenzo_3d1l(EQ* eq, T* outlier, dim3 len3, dim3 stride3, int radius, FP ebx2, T* xdata);

namespace delta_only {

template <typename T, typename EQ, typename FP>
__global__ void c_lorenzo_3d1l(T* data, dim3 len3, dim3 stride3, FP ebx2_r, EQ* eq);

template <typename T, typename EQ, typename FP>
__global__ void x_lorenzo_3d1l(EQ* eq, dim3 len3, dim3 stride3, FP ebx2, T* xdata);
...
template <typename T, typename EQ, typename FP, int BLOCK, int SEQ>
__global__ void
psz::cuda::__kernel::v0::c_lorenzo_1d1l(T* data, dim3 len3, dim3 stride3, int radius, FP ebx2_r, EQ* eq, T* outlier)
{
    ...
    subr_v0::predict_quantize_1d<T, EQ, SEQ, true>(thp_data, s.eq, s.outlier, radius, prev);
    subr_v0::predict_quantize_1d<T, EQ, SEQ, false>(thp_data, s.eq, s.outlier, radius);
    subr_v0::write_1d<EQ, T, NTHREAD, SEQ, false>(s.eq, s.outlier, len3.x, id_base, eq, outlier);
}

template <typename T, typename EQ, typename FP, int BLOCK, int SEQ>
__global__ void psz::cuda::__kernel::v0::delta_only::c_lorenzo_1d1l(T* data, dim3 len3, dim3 stride3, FP ebx2_r, EQ* eq)
{
    namespace subr_v0 = psz::cuda::__device::v0;
    ...
    subr_v0::load_prequant_1d<T, FP, NTHREAD, SEQ>(data, len3.x, id_base, s.data, thp_data, prev, ebx2_r);
    subr_v0::predict_quantize__no_outlier_1d<T, EQ, SEQ, true>(thp_data, s.eq, prev);
    subr_v0::predict_quantize__no_outlier_1d<T, EQ, SEQ, false>(thp_data, s.eq);
    subr_v0::write_1d<EQ, T, NTHREAD, SEQ, false>(s.eq, nullptr, len3.x, id_base, eq, nullptr);
}
    ...
    T*   xdata)
{
    ...
    subr_v0::load_fuse_1d<T, EQ, NTHREAD, SEQ>(eq, outlier, len3.x, id_base, radius, s.xdata, thp_data);
    ...
    T*   xdata)
{
    ...
    subr_v0::delta_only::load_1d<T, EQ, NTHREAD, SEQ>(eq, len3.x, id_base, s.xdata, thp_data);
    subr_v0::block_scan_1d<T, SEQ, NTHREAD>(thp_data, ebx2, s.exchange_in, s.exchange_out, s.xdata);
    subr_v0::write_1d<T, T, NTHREAD, SEQ, true>(s.xdata, nullptr, len3.x, id_base, xdata, nullptr);
}
...
template <typename T, typename EQ, typename FP>
__global__ void
psz::cuda::__kernel::v0::c_lorenzo_2d1l(T* data, dim3 len3, dim3 stride3, int radius, FP ebx2_r, EQ* eq, T* outlier)
{
    namespace subr_v0 = psz::cuda::__device::v0;
    ...
    subr_v0::quantize_write_2d<T, EQ, YSEQ>(center, len3.x, gix, len3.y, giy_base, stride3.y, radius, eq, outlier);
}

template <typename T, typename EQ, typename FP>
__global__ void psz::cuda::__kernel::v0::delta_only::c_lorenzo_2d1l(T* data, dim3 len3, dim3 stride3, FP ebx2_r, EQ* eq)
{
    namespace subr_v0 = psz::cuda::__device::v0;
    ...
    subr_v0::load_prequant_2d<T, FP, YSEQ>(data, len3.x, gix, len3.y, giy_base, stride3.y, ebx2_r, center);
    subr_v0::predict_2d<T, EQ, YSEQ>(center);
    subr_v0::delta_only::quantize_write_2d<T, EQ, YSEQ>(center, len3.x, gix, len3.y, giy_base, stride3.y, eq);
}
    ...
    T*   xdata)
{
    ...
    subr_v0::load_fuse_2d<T, EQ, YSEQ>(eq, outlier, len3.x, gix, len3.y, giy_base, stride3.y, radius, thread_private);
    ...
    T*   xdata)
{
    ...
    subr_v0::delta_only::load_2d<T, EQ, YSEQ>(eq, len3.x, gix, len3.y, giy_base, stride3.y, thread_private);
    subr_v0::block_scan_2d<T, EQ, FP, YSEQ>(thread_private, intermediate, ebx2);
    subr_v0::decomp_write_2d<T, YSEQ>(thread_private, len3.x, gix, len3.y, giy_base, stride3.y, xdata);
}
...
template <typename T, typename EQ, typename FP>
__global__ void
psz::cuda::__kernel::v0::c_lorenzo_3d1l(T* data, dim3 len3, dim3 stride3, int radius, FP ebx2_r, EQ* eq, T* outlier)
{
    constexpr auto BLOCK = 8;
    __shared__ T   s[9][33];
    ...
    EQ*  eq)
{
    ...
    auto quantize_write = [&](T delta, auto x, auto y, auto z, auto gid) {
        if (x < len3.x and y < len3.y and z < len3.z) eq[gid] = static_cast<EQ>(delta);
    };
