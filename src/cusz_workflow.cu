    ...
    bool&                    nvcomp_in_use)
{
    ...
    std::tie(n_bits, n_uInt, huffman_metadata_size, nvcomp_in_use) =
        HuffmanEncode<Q, H>(ap->c_huff_base, d_bcode, len, ap->huffman_chunk, ap->to_gzip, dims_L16[CAP]);
    ...
    bool nvcomp_in_use)
{
    ...
    if (ap->skip_huffman) {
        ...
        xbcode = HuffmanDecode<Q, H>(ap->cx_path2file, len, ap->huffman_chunk, total_uInt, nvcomp_in_use, dict_size);
...
template void
cusz::workflow::Decompress<float, uint8__t, uint32_t>(argpack*, size_t*, double*, int&, size_t&, size_t&, size_t&, bool);
template void
cusz::workflow::Decompress<float, uint8__t, uint64_t>(argpack*, size_t*, double*, int&, size_t&, size_t&, size_t&, bool);
template void
cusz::workflow::Decompress<float, uint16_t, uint32_t>(argpack*, size_t*, double*, int&, size_t&, size_t&, size_t&, bool);
template void
cusz::workflow::Decompress<float, uint16_t, uint64_t>(argpack*, size_t*, double*, int&, size_t&, size_t&, size_t&, bool);
